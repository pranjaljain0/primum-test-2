    ...
    <>
        ...
        {plans.map((plan, index) => (
          ...
          >
            ...
            <div className="pt-0 text-left md:pt-14">
              ...
              <h1 className="text-sm UbuntuRegular text-neutral-coolGray">
                {optionPrice ? '+$' + plan.priceYr + '/yr' : '+$' + plan.priceMo + '/mo'}
              </h1>
              <h1 className="pt-1 text-xs UbuntuBold text-primary-marineBlue">
                {optionPrice ? '2 months free ' : ''}
              </h1>
            </div>
          </button>
        ))}
      ...
      <div className="flex items-center justify-center p-4 mt-6 bg-neutral-alabaster">
        <div className="flex items-center space-x-3">
          <h1
            className={`text-sm UbuntuMedium  ${
              optionPrice == false ? 'text-primary-marineBlue' : 'text-neutral-coolGray'
            }`}
          >
            Monthly
          </h1>
          <label htmlFor="anually" className="relative cursor-pointer h-7 w-14">
            ...
            <span
              id="customSlider"
              className="absolute inset-0 transition rounded-full bg-neutral-lightGray peer-checked:bg-primary-marineBlue"
            ></span>
            <span className="absolute inset-0 m-1 h-5 w-5 rounded-full bg-gray-300 ring-[6px] ring-inset ring-white transition-all peer-checked:w-5 peer-checked:translate-x-7 peer-checked:bg-white peer-checked:ring-transparent">
              {' '}
            </span>
          </label>
          <h1
            className={`text-sm UbuntuMedium  ${
              optionPrice == true ? 'text-primary-marineBlue' : 'text-neutral-coolGray'
            }`}
          >
            Yearly
          </h1>
