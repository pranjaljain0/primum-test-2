          ...
          {!showThanks ? (
            ...
            <>
              ...
              <span className="text-lg UbuntuRegular text-neutral-coolGray">
                ...
                <span className="cursor-pointer relative font-medium text-primary-purplishBlue before:absolute before:-bottom-1 before:h-0.5 before:w-full before:origin-left before:scale-x-0 before:bg-primary-purplishBlue before:transition hover:before:scale-100">
