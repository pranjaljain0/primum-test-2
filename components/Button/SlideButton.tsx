      ...
      {step != 4 ? (
        ...
        >
          {step > 0 ? (
            <button
              type="button"
              onClick={() => handlePrevStep(setStep)}
              className="px-4 py-2 text-base transition rounded-md text-neutral-coolGray UbuntuBold hover:text-neutral-coolGray/50 hover:scale-90"
            >
              Go Back
            </button>
          ) : null}
          <button
            ...
            className={`w-32 h-12 px-4 py-2 text-base text-white rounded-md UbuntuRegular transition hover:scale-90
                ${
                  step == 3
                    ? 'bg-primary-purplishBlue hover:bg-primary-purplishBlue/90'
                    : 'bg-primary-marineBlue hover:bg-primary-marineBlue/90'
                }
                `}
          >
